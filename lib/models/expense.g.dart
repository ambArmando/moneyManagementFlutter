...
void _expenseSerialize(
  ...
  writer.writeDouble(offsets[2], object.spendedValue);
}
...
Expense _expenseDeserialize(
  ...
  final object = Expense(
    ...
    spendedValue: reader.readDouble(offsets[2]),
  );
  object.id = id;
  return object;
}
...
extension ExpenseQueryFilter
  ...
  QueryBuilder<Expense, Expense, QAfterFilterCondition> spendedValueEqualTo(
    double value, {
    double epsilon = Query.epsilon,
  }) {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.equalTo(
        property: r'spendedValue',
        value: value,
        epsilon: epsilon,
      ));
    });
  ...
  QueryBuilder<Expense, Expense, QAfterFilterCondition> spendedValueGreaterThan(
    double value, {
    bool include = false,
    double epsilon = Query.epsilon,
  }) {
  ...
  QueryBuilder<Expense, Expense, QAfterFilterCondition> spendedValueLessThan(
    double value, {
    bool include = false,
    double epsilon = Query.epsilon,
  }) {
  ...
  QueryBuilder<Expense, Expense, QAfterFilterCondition> spendedValueBetween(
    double lower,
    double upper, {
    bool includeLower = true,
    bool includeUpper = true,
...
extension ExpenseQuerySortBy on QueryBuilder<Expense, Expense, QSortBy> {
  ...
  QueryBuilder<Expense, Expense, QAfterSortBy> sortBySpendedValue() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'spendedValue', Sort.asc);
    });
  }

  QueryBuilder<Expense, Expense, QAfterSortBy> sortBySpendedValueDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'spendedValue', Sort.desc);
    });
  }
}
...
extension ExpenseQuerySortThenBy
  ...
  QueryBuilder<Expense, Expense, QAfterSortBy> thenBySpendedValue() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'spendedValue', Sort.asc);
    });
  }

  QueryBuilder<Expense, Expense, QAfterSortBy> thenBySpendedValueDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'spendedValue', Sort.desc);
    });
  }
...
extension ExpenseQueryWhereDistinct
  ...
  QueryBuilder<Expense, Expense, QDistinct> distinctBySpendedValue() {
    return QueryBuilder.apply(this, (query) {
      return query.addDistinctBy(r'spendedValue');
    });
  }
}
...
extension ExpenseQueryProperty
  ...
  QueryBuilder<Expense, double, QQueryOperations> spendedValueProperty() {
    return QueryBuilder.apply(this, (query) {
      return query.addPropertyName(r'spendedValue');
    });
  }
}
